...
if (isset($_GET['reporteClientesHabituales']) and isset($_GET['fechaInicio']) and isset($_GET['fechafin'])) {
    $Sucursal = $_GET['reporteClientesHabituales'];
    $Inicio = $_GET['fechaInicio'];
    $Fin = $_GET['fechafin'];

    header("Content-type: application/vnd.ms-excel; name='excel'");
    header("Content-Disposition: filename=reporteClientesHabituales" . $Inicio . "__" . $Fin . ".xls");
    ...
    <thead>
        <tr>
            <th colspan="9" style="text-align: left;">
                <h3><span style="text-transform: uppercase;letter-spacing: 1px;font-size: 16px">CLIENTES HABITUALES QUE VIENEN CADA VEZ  
                 <br> SIN IMPORTAR LA CANTIDAD Y EL VALOR ==> <span
