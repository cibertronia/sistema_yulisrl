...
if (isset($_GET['reporteClientesCantidadDinero']) and isset($_GET['fechaInicio']) and isset($_GET['fechafin'])) {
    $Sucursal = $_GET['reporteClientesCantidadDinero'];
    $Inicio = $_GET['fechaInicio'];
    $Fin = $_GET['fechafin'];

    header("Content-type: application/vnd.ms-excel; name='excel'");
    header("Content-Disposition: filename=reporteClientesCantidadDinero" . $Inicio . "__" . $Fin . ".xls");
    ...
    <thead>
        <tr>
            <th colspan="9" style="text-align: left;">
                <h3><span style="text-transform: uppercase;letter-spacing: 1px;font-size: 16px">Clientes que compraron mas en cantidad de dinero ==> <span
        ...
        <tr>
            ...
            <th class="text-center" style="text-align: center;background-color: #FDE9D9">
                Empresa</th>
            <th class="text-center" style="text-align: center;background-color: #FDE9D9">
                Cantidad <br>En Dinero <br>Comprados USD</th>
            <th class="text-center" style="text-align: center;background-color: #FDE9D9">
                Cantidad <br>En Dinero <br>Comprados Bs</th>
            <th class="text-center" style="text-align: center;background-color: #FDE9D9">
                Sucursal</th>
    ...
    ?>
        <tr>
            ...
            <td style="text-align: center;background-color: #D8E4BC">
                <?php echo number_format(($dataVenta['TotalVentaUS']), 2, ",",""); ?></td>
            <td style="text-align: center;background-color: #D8E4BC">
                <?php echo number_format(($dataVenta['TotalVentaBs']), 2, ",","");?></td>
