<?php include 'php/left_ventas.php'; ?><div id="sidebar" class="sidebar ">
	<div data-scrollbar="true" data-height="100%">
		...
		<ul class="nav">
			...
			<li class="">
				<a href=" /"><i class="fa fa-home bg-dark active"></i><span>INICIO</span></a>
			</li><?php
			if ($_SESSION['Rango']) {
				if ($_SESSION['Rango']=='2') { ?>
				<li>						
		  ...
		  <li class="has-sub">
			...
			<li class="has-sub active">
				...
				<ul class="sub-menu">
					...
					<li class="active"><a href="?root=porAnticipo"><i class="fas fa-archive" style="font-size: 20px"></i>
