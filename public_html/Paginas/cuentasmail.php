					...
					<div class="col-md-6">
						<div class="panel panel-inverse">
							<div class="panel-heading">
								<h4 class="panel-title">LISTA DE CUENTAS DE CORREO</h4>
								...
								<table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle w-100">
									...
									<tbody>
										<?php
											include 'includes/conexion.php';
											$Num = 1;
											$queryCuentaMail	=	mysqli_query($MySQLi,"SELECT * FROM CuentasMail");
											while ($dataMail	=	mysqli_fetch_assoc($queryCuentaMail)) {
										?>
										<tr class="odd gradeX">
											<td class="text-center"><?php echo $Num; ?></td>
											<td class="text-center"><?php echo $dataMail['Sucursal'] ?></td>
											<td class="text-center"><?php echo $dataMail['Correo'] ?></td>
											<td class="text-center"><?php echo $dataMail['Password'] ?></td>
