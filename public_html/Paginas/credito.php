...
<body><?php
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed"><?php
                                                                                ...
                                                                                include 'php/left_menu_credito.php';
        ...
        <div id="content" class="content">
            <div class="respuesta"></div><?php
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                <h4 class="panel-title">COTIZACIONES AL CRÉDITO DESDE <strong class="text-danger"><?php echo $Inicio ?></strong> HASTA <strong class="text-danger"><?php echo $Fin ?></strong></h4>
                            ...
                            <div class="panel-body">
                                <form data-parsley-validate="true" class="w-75 m-auto" id="buscar" action="?root=credito" method="POST">
                                    <div class="row mb-2">
                                ...
                                <table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle w-100">
                                    ...
                                    <tbody> <?php $Num =    1;
                                                if ($_SESSION['Rango'] == 2) {
                                                    $consultaCotizacion    =    mysqli_query($MySQLi, "SELECT idCotizacion, Code, Clave, idUser, idCliente, Forma_Pago, DATE_FORMAT(FinFecha_Oferta, '%d de %M, %Y') AS FinFecha_Oferta, Dias_Entrega, Comentarios, Sucursal, DATE_FORMAT(Fecha, '%d de %M, %Y') AS Fecha, DATE_FORMAT(Hora, '%h:%i:%s %p') AS Hora, DATE_FORMAT(Entregada, '%d de %M, %Y') AS Entregada FROM Cotizaciones WHERE Estado=4 AND Fecha BETWEEN '$Inicio' AND '$Fin' ORDER BY Fecha DESC");
                                                } else {
                                                    $consultaCotizacion    =    mysqli_query($MySQLi, "SELECT idCotizacion, Code, Clave, idUser, idCliente, Forma_Pago, DATE_FORMAT(FinFecha_Oferta, '%d de %M, %Y') AS FinFecha_Oferta, Dias_Entrega, Comentarios, Sucursal, DATE_FORMAT(Fecha, '%d de %M, %Y') AS Fecha, DATE_FORMAT(Hora, '%h:%i:%s %p') AS Hora, DATE_FORMAT(Entregada, '%d de %M, %Y') AS Entregada FROM Cotizaciones WHERE idUser='$idUser'AND Estado=4 AND Fecha BETWEEN '$Inicio' AND '$Fin' ORDER BY Fecha DESC");
                                                }
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td style="font-size: 10px">
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col text-center f-s-20">
                                                            <a title="Descargar Nota de entrega" href="Reportes/pdf.php?NotaE_idCotiza=<?php echo $IDCotiza ?>" class="btn btn-xs btn-danger">
                                                ...
                                                <td style="font-size: 12px;">
                                                    ...
                                                    <table class="table table-success table-striped table-bordered table-td-valign-middle w-100">
                                                        ...
                                                        <tbody><?php
                                                                ...
                                                                </tr><?php }/*	HASTA AQUI LOS DATOS DEL PRODUCTO	*/ ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right">$
                                                                    ...
                                                                    $findAbono     =    mysqli_query($MySQLi, "SELECT Moneda, Total FROM Creditos WHERE idCotizacion='$IDCotiza' LIMIT 0,1 ") or die(mysqli_error($MySQLi) . "<br>Error en la línea: " . __LINE__);
                                                            ...
                                                            $sqlAbono     =    mysqli_query($MySQLi, "SELECT * FROM Creditos WHERE idCotizacion='$IDCotiza' ") or die(mysqli_error($MySQLi));
                                                            $CantRecibos =    mysqli_num_rows($sqlAbono);
                                                            while ($dataRecibo    =    mysqli_fetch_assoc($sqlAbono)) {
                                                                $idRecibo         =    $dataRecibo['idRecibo'];
                                                                $idAbono         =    $dataRecibo['idCredito'];
                                                                echo '
																		<tr>
                                                            ...
                                                            <tr>
                                                                <td colspan="3" class="text-right"><?php
                                                                                                    if ($CantRecibos > 1) {
                                                                                                        ...
                                                                                                        $buscarAbono =    mysqli_query($MySQLi, "SELECT * FROM Creditos WHERE idCotizacion='$IDCotiza' LIMIT $AbonoEdit,1 ") or die(mysqli_error($MySQLi) . "<br>Error en la línea: " . __LINE__);
                                                                                                        $AbonoEditar =    mysqli_fetch_assoc($buscarAbono);
                                                                                                        $thisAbonoID =    $AbonoEditar['idCredito'];
                                                                                                        $thisReciboID =    $AbonoEditar['idRecibo'];
                                                                                                        $thisMoneda =    $AbonoEditar['Moneda'];
                                                                                                        if ($_SESSION['Rango'] == '2') {
                                                                                                            echo '
                                                                ...
                                                                <?php
                                                                $search     =    mysqli_query($MySQLi, "SELECT * FROM Creditos WHERE idCotizacion='$IDCotiza' ");
                                                                $dataSearch =    mysqli_fetch_assoc($search);
                                                                if ($dataSearch['Moneda'] == 'USD') {
                                                                    $ConsultaRecibo_ =    mysqli_query($MySQLi, "SELECT Moneda,SUM(AbonoUSD) AS AbonoUSD, TotalUSD FROM Creditos WHERE idCotizacion='$IDCotiza' ");
                                                                    $dataRecibo_ = mysqli_fetch_assoc($ConsultaRecibo_);
                                                                    $Total         =    $dataRecibo_['TotalUSD'];
                                                                    $Abonos     =    $dataRecibo_['AbonoUSD'];
                                                                    $Resta         =    $Total - $Abonos;
                                                                    echo '
																			<td class="text-right"><strong>
																				USD $</strong> ' . number_format($Resta, 2) . '
																			</td>';
                                                                } else {
                                                                    /*	SI LA MONEDA ES Bs	*/
                                                                    $ConsultaRecibo_ =    mysqli_query($MySQLi, "SELECT Moneda,SUM(porAbono) AS porAbono, Total FROM Creditos WHERE idCotizacion='$IDCotiza' ");
                                                                    $dataRecibo_ = mysqli_fetch_assoc($ConsultaRecibo_);
                                                                    $Total         =    $dataRecibo_['Total'];
                                                                    $Abonos     =    $dataRecibo_['porAbono'];
                                                                    $Resta         =    $Total - $Abonos;
                                                                    echo '
																			<td class="text-right"><strong>
																				Bs $</strong> ' . number_format($Resta, 2) . '
																			</td>';
                                                                }
                                                                ?>
                                                            </tr>
                                                            ...
                                                            $queryRecibos     =    mysqli_query($MySQLi, "SELECT * FROM Creditos WHERE idCotizacion='$IDCotiza' ");
                                                            $respConsulta    =    mysqli_num_rows($queryRecibos);
                                                            $Busqueda         =    $respConsulta - 1;
                                                            $buscarRecibo    =    mysqli_query($MySQLi, "SELECT * FROM Creditos WHERE idCotizacion='$IDCotiza' LIMIT $Busqueda,1 ") or die(mysql_error($MySQLi));
                                                            $dataBusqueda     =    mysqli_fetch_assoc($buscarRecibo);
                                                            $IDAbono         =    $dataBusqueda['idCredito'];
                                                ...
                                                <?php
                                                    if ($_SESSION['Rango'] == '2') { ?>
                                                    <td class="text-center"><button class="btn btn-danger btn-xs eliminarCreditoProceso" title="Borrar Credito Proceso(<?php echo $IDCotiza ?>)" id="<?php echo $IDCotiza ?>"><i class="fas fa-trash-alt"></i></button>
                                                    </td><?php
                                                        } ?>
                ...
                <div class="row tableCotizaciones">
                    <div class="col-md-12">
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                <h4 class="panel-title">COTIZACIONES AL CRÉDITO
                            ...
                            <div class="panel-body">
                                <form data-parsley-validate="true" class="w-75 m-auto d-none" id="buscar" action="?root=credito" method="POST">
                                    <div class="row mb-2">
                                        <div class="col text-center">
                                            <label for="fechaInicio">Fecha de inicio</label>
                                ...
                                <table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle w-100">
                                    ...
                                    <tbody> <?php $Num =    1;
                                                if ($_SESSION['Rango'] == 2) {
                                                    $consultaCotizacion    =    mysqli_query($MySQLi, "SELECT idCotizacion, Code, Clave, idUser, idCliente, Forma_Pago, DATE_FORMAT(FinFecha_Oferta, '%d de %M, %Y') AS FinFecha_Oferta, Dias_Entrega, Comentarios, Sucursal, DATE_FORMAT(Fecha, '%d de %M, %Y') AS Fecha, DATE_FORMAT(Hora, '%h:%i:%s %p') AS Hora, DATE_FORMAT(Entregada, '%d de %M, %Y') AS Entregada FROM Cotizaciones WHERE Estado=4 AND Fecha BETWEEN '$startBusqueda'AND'$fecha' ORDER BY Fecha DESC");
                                                } else {
                                                    $consultaCotizacion    =    mysqli_query($MySQLi, "SELECT idCotizacion, Code, Clave, idUser, idCliente, Forma_Pago, DATE_FORMAT(FinFecha_Oferta, '%d de %M, %Y') AS FinFecha_Oferta, Dias_Entrega, Comentarios, Sucursal, DATE_FORMAT(Fecha, '%d de %M, %Y') AS Fecha, DATE_FORMAT(Hora, '%h:%i:%s %p') AS Hora, DATE_FORMAT(Entregada, '%d de %M, %Y') AS Entregada FROM Cotizaciones WHERE idUser='$idUser'AND Estado=4 AND Fecha BETWEEN '$startBusqueda'AND'$fecha' ORDER BY Fecha DESC");
                                                }
                                                while ($dataCotizacion = mysqli_fetch_assoc($consultaCotizacion)) {
                                                    $IDCotiza     =    $dataCotizacion['idCotizacion']; ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td style="font-size: 12px;">
                                                    ...
                                                    <table class="table table-success table-striped table-bordered table-td-valign-middle w-100">
                                                        ...
                                                        <tbody><?php
                                                            ...
                                                            $respConsulta    =    mysqli_num_rows($queryRecibos);
                                                            $Busqueda         =    $respConsulta - 1;
                                                            $buscarRecibo    =    mysqli_query($MySQLi, "SELECT * FROM Creditos WHERE idCotizacion='$IDCotiza' LIMIT $Busqueda,1 ");
                                                            $dataBusqueda     =    mysqli_fetch_assoc($buscarRecibo);
                                                            $IDAbono         =    $dataBusqueda['idCredito'];
                                                            //$ultminoSaldo 	=	$dataBusqueda['SaldoActual'];
                                                            //echo $ultminoSaldo;
            ...
            <!-- TABLA AGREGAR ABONO CRÉDITO -->
            <div class="row tablaAbonoCredito w-50 m-auto d-none">
                <div class="col-md-12">
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <h4 class="panel-title">FORMULARIO DE ABONO</h4>
                            <div class="panel-heading-btn">
                                <button class="btn btn-danger btn-xs closeTablaCredito"> CERRAR </button>&nbsp;&nbsp;
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-redo"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-danger" data-click="panel-remove"><i class="fa fa-times"></i></a>
                            ...
                            <form id="formPlus_Abono" data-parsley-validate="true">
                                <div class="row">
                                    ...
                                    <div class="col text-center">
                                        ...
                                        <input type="text" name="dolar" id="PrecioDolar" class="form-control text-center" value="<?php echo $PrecioDolar ?>">
                                    </div>
                                </div>
                                <div class="row text-center mt-3">
                                    <div class="col">
                                        <label for="selectMoneda"><strong>MONEDA</strong></label>
                                        <input type="hidden" name="action" value="AgregarNuevoAbonoCredito">
                                ...
                                <div class="row mt-2">
                                    <div class="col">
                                        <button type="submit" class="btn btn-xs btn-info form-control addNewAbono">AGREGAR NUEVO ABONO
                                            &nbsp;<i class="fas fa-spinner fa-pulse d-none new_Abono"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <!-- FORMULARIO EDITAR PRIMER ABONO CRÉDITO -->
            <div class="row formEditCredito1 w-50 m-auto d-none">
                <div class="col-md-12">
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <h4 class="panel-title">EDITAR ABONO POR <span id="Cant_Abono"></span></h4>
                            <div class="panel-heading-btn">
                                <button class="btn btn-danger btn-xs closeEditCredito1"> CERRAR </button>&nbsp;&nbsp;
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-redo"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-danger" data-click="panel-remove"><i class="fa fa-times"></i></a>
                        ...
                        <div class="panel-body">
                            <form id="formAbonoCredito" data-parsley-validate="true">
                                <div class="row">
                                    <div class="col text-center">
                                ...
                                <div class="row text-center mt-3">
                                    <div class="col">
                                        ...
                                        <input type="hidden" name="action" value="editarAbonoCredito">
                                        <input type="hidden" name="idUser" value="<?php echo $idUser ?>">
                                ...
                                <div class="row mt-2">
                                    <div class="col">
                                        <button type="submit" class="btn btn-xs btn-info form-control updatePrimerAbono">ACTUALIZAR
                                            RECIBO</button>
                                    </div>
                                </div>
                            </form>
            ...
            <!-- FORMULARIO EDITAR SEGUNDO O MAS ABONOS CRÉDITO -->
            <div class="row formEditCredito2 w-50 m-auto d-none">
                <div class="col-md-12">
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <h4 class="panel-title">FORMULARIO ULTIMO RECIBO</h4>
                            <div class="panel-heading-btn">
                                <button class="btn btn-danger btn-xs closeEditCredito2"> CERRAR </button>&nbsp;&nbsp;
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-redo"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-danger" data-click="panel-remove"><i class="fa fa-times"></i></a>
                        ...
                        <div class="panel-body">
                            <form id="form_Recibo" data-parsley-validate="true">
                                <div class="row">
                                    <div class="col text-center">
                                        <label for="codeCotizacion"><strong>Código de la cotización</strong></label>
                                        <input type="text" name="Code" id="codeCotizacion" class="form-control text-center">
                                    </div>
                                    <div class="col text-center">
                                        <label for="precioDolar"><strong>Precio Dólar</strong></label>
                                ...
                                <div class="row text-center mt-3">
                                    <div class="col">
                                        <label for="selectMoneda_"><strong>MONEDA</strong></label>
                                        <input type="hidden" name="action" value="ActualizarReciboCredito">
                                ...
                                <div class="row mt-2 text-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="saldoAct2" id="Saldo_Act" class="form-control d-none text-center" data-parsley-required="true" data-parsley-type="number">
                                        <div class="text-center text-danger d-none noSaldoActual">Vacío</div>
                                    </div>
                                </div>
                                <div class="row mt-2 text-center">
                                ...
                                <div class="row mt-2">
                                    <div class="col">
                                        <button type="submit" class="btn btn-xs btn-info form-control updateRecibo">ACTUALIZAR
                                            RECIBO</button>
                                    </div>
                                </div>
                            </form>
    ...
    <?php include 'php/script_creditos.php'; ?>
    <!-- 	SCRIPT PARA EDITAR EL PRIMER ABONO	-->
    <script type="text/javascript">
        $(document).ready(function() {
            $("#by_Cantidad").keyup(function() {
                var Anticipo = $(this).val(); /*	ESTE ES EL VALOR DE LA CASILLA: "	POR LA CANTIDAD DE	"	*/
                var Total = $("#by_Total").val(); /*	ESTE ES EL VALOR DE LA CASILLA: "	TOTAL	"	*/
                var SaldoAnt = Total - Anticipo; /*	VALOR DE LA CASILLA SALDO ANTERIOR	*/
                var Moneda = $("#selectMoneda_").val();

                /*	LA CASILLA ANTICIPO, VA A CAMBIAR SEGUN EL VALOR DE LA CASILLA CANTIDAD (POR LA CANTIDAD DE)	*/
                $("#by_Anticipo").val(Anticipo);
                $("#SaldoAct").val((SaldoAnt).toFixed(2));
                if (Moneda == 'USD') {
                    $("#Cant_Abono").html("<span class='text-danger'>$</span> " + Anticipo +
                        " <span class='text-danger'>Dólares</span>");
                } else {
                    $("#Cant_Abono").html("<span class='text-danger'>Bs</span> " + Anticipo +
                        " <span class='text-danger'>Bolivianos</span>");
                }
                if (Anticipo == '') {
                    $("#Cant_Abono").html("");
                }
    ...
    <!--sCRIPT editar segundo abono o mas...-->
    <script type="text/javascript">
        $(document).ready(function() {
            /*$("#by_Cantidad_").keyup(function () {
		       		var Anticipo =	$(this).val();
		       		var Total 	 =	$("#by_Total_").val();
		       		var SaldoAnt =	Total-Anticipo;


		       		$("#by_Anticipo_").val(Anticipo);
		       		$("#Saldo_actual").val((SaldoAnt).toFixed(2));
		    	});*/
            $("#by_Cantidad_").keyup(function() {
                $("#_sumaRecibo").val("");
                var Cantidad = $(this).val();
                $("#by_Anticipo_").val(Cantidad);
                $("#Saldo_Ant").val("");
                var SaldoActual = $("#Saldo_actual").val();
                $("#Saldo_Ant").val(SaldoActual);
                $("#Saldo_actual").addClass('d-none');
                $("#Saldo_Act").removeClass('d-none');
                $("#Saldo_Act").val(SaldoActual - Cantidad);
            });
        });
    </script>
    <!-- 	FORMULARIO PARA AGREGAR O EDITAR COMENTARIOS	-->
