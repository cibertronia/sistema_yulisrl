                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <span style="text-transform: uppercase;letter-spacing: 1px;font-size: 16px">CLIENTES QUE
                                    COMPRARON <br> EN MÁS CANTIDAD DE DINERO ==> <span
                            ...
                            <div class="panel-heading-btn">
                                ...
                                <div class="input-group input-daterange">
                                    <form action="?root=clientes2" method="post">
    ...
    echo '<option value=' . $dataSucursal['idSucursal'] . '>' . $dataSucursal['Sucursal'] . '</option>';}?>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a class="btn btn-success btn-sm btn-block"
                                            href="Reportes/reporteClientesCantidadDinero.php?reporteClientesCantidadDinero=<?php echo $Sucursal ?>&fechaInicio=<?php echo $Inicio ?>&fechafin=<?php echo $Fin ?>"
                                            title="CLIENTES QUE COMPRARON EN MÁS CANTIDAD DE DINERO"><span
                                                style="color: white">
                                                EXCEL DESCARGAR</span>&nbsp;&nbsp;
                                            <i class="fa fa-download" style="color: white"></i>
                                        </a>
    ...
    ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;background-color: #D8E4BC">
                                                        <?php echo $dataVenta['TotalVentaUS'] ?></td>
                                                    <td style="text-align: center;background-color: #D8E4BC">
                                                        <?php echo $dataVenta['TotalVentaBs'] ?></td>
...
;?>
    ...
    <?php include 'php/script_clientes2.php';?>
