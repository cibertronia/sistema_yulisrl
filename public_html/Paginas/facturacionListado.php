...
$branchId = $sucursal[0]['idSucursal'] ?? 0;
...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed" data-rango="<?= $_SESSION['Rango'] ?>">
        <?php
        include 'php/top_menu.php';
        include 'php/left_menu_facturacion.php';
        ?>
        <div id="content" class="content">
                            ...
                            <form id="editUserList">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input readonly type="text" name="invoiceNumber1" id="invoiceNumber1" class="form-control" placeholder="invoiceNumber1" maxlength="">
                                    </div>
                                    <div class="col">
                                        <label for="invoiceCode1">CODIGO DE FACTURA</label>
                                        <input type="hidden" name="action" value="ActualizarUsuarioLista">
                                        <input type="hidden" name="id" id="id">
                                        <input readonly type="text" name="invoiceCode1" id="invoiceCode1" class="form-control" placeholder="invoiceCode1" maxlength="">
                                    </div>
                                    <div class="col">
            ...
            <div class="row tableUsers">
                <div class="col-md-12">
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <h4 class="panel-title">LISTA DE FACTURAS
                            ...
                            <div class="panel-heading-btn">
                                ...
                                <div class="input-group input-daterange">
                                    <form action="?root=facturacionListado" method="post">
                        ...
                        <div class="panel-body">
                            <!-- seccion de estadisticas solo para administradores -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    ...
                                    FROM
                                        factura
                                    WHERE
                                        branchId = $branchId AND siatCodeState = 908 AND ( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' )") or die(mysqli_error($MySQLi));
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="widget widget-stats bg-success">
                                        ...
                                        factura
                                    WHERE
                                        branchId = $branchId AND siatCodeState = 908 AND ( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' )");
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="widget widget-stats bg-gray">
                                        ...
                                        factura
                                    WHERE
                                        branchId = $branchId AND siatCodeState = 905 AND ( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' )");
                                    ...
                                    <div class="widget widget-stats bg-info">
                                        ...
                                        <div class="stats-info">
                                            ...
                                            <p><?php
                                                ...
                                                $totalfacturado = 0;
                                                $QueryFactura = mysqli_query($MySQLi, "SELECT* FROM detailInvoice WHERE branchId=$branchId  AND( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' ) ORDER BY invoiceNumber DESC");

                                                while ($data = mysqli_fetch_assoc($QueryFactura)) {

                                                    $nroFactura = $data['invoiceNumber'];
                                                    $qtyFactura = $data['qty'];
                                                    $QueryFacturaCabezera = mysqli_query($MySQLi, "SELECT* FROM factura WHERE branchId=$branchId AND invoiceNumber='$nroFactura'  ");
                            ...
                            <?php } ?>
                            <table id="data-table-buttons-facturas" width="100%" class="table table-striped table-bordered table-td-valign-middle w-100">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    while ($data = mysqli_fetch_assoc($QueryFactura)) {
                                        ...
                                        // $QueryFacturaFecha = mysqli_query($MySQLi, "SELECT* FROM factura WHERE branchId=$branchId AND invoiceNumber='$nroFactura' ");
                                        // $dataFacturaFecha = mysqli_fetch_assoc($QueryFacturaFecha);

                                        // $dateEmissionFactura=$dataFacturaFecha['dateEmission'];
                                        // $date = strtotime($dateEmissionFactura);
                                        // $dateFactura= date('d-m-Y', $date);



                                        // $QueryFacturaCabezera = mysqli_query($MySQLi, "SELECT id ,  nitEmissor ,  clientReasonSocial ,  clientNroDocument ,  invoiceCode ,  cuf ,  invoiceNumber ,  qrCode ,  invoiceUrl , DATE_FORMAT(dateEmission, '%d-%m-%Y')AS dateEmission ,  amountTotal ,  amountTotalDiscount ,  amountTotalCurrency ,  userCashier ,  siatCodeState ,  siatCodeReception ,  siatDescriptionStatus ,  countItems ,  invoiceXml ,  clientEmail ,  posId ,  branchId ,  idCotizacion ,  exceptionCode ,  tipoFactura FROM factura WHERE branchId=$branchId AND invoiceNumber='$nroFactura' AND dateEmission BETWEEN '$Inicio' AND '$Fin' ");
                                        // $dataFacturaCabezera = mysqli_fetch_assoc($QueryFacturaCabezera);
