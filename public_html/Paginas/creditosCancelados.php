...
<head>
    <title>CRÉDITOS CANCELADOS</title>
...
<body><?php
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed"><?php
                                                                                ...
                                                                                include 'php/left_menu_creditoCancelado.php';
            ...
            <div class="respuesta"></div><?php
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                <h4 class="panel-title">COTIZACIONES CANCELADAS AL CRÉDITO DESDE <strong class="text-danger"><?php echo $Inicio ?></strong> HASTA <strong class="text-danger"><?php echo $Fin ?></strong></h4>
                            ...
                            <div class="panel-body">
                                <form data-parsley-validate="true" class="w-75 m-auto" id="buscar" action="?root=creditosCancelados" method="POST">
                                    <div class="row mb-2">
                                ...
                                <table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle w-100">
                                    <thead>
                                        <tr class="table-success">
                                            ...
                                            <th width="55%" class="text-center">Productos</th>
                                            <th width="10%" class="text-center">Acciones</th>
                                        </tr>
                                    </thead>
                                    <tbody> <?php $Num =    1;
                                                if ($_SESSION['Rango'] == 2) {
                                                    $consultaCotizacion    =    mysqli_query($MySQLi, "SELECT idCotizacion, Code, Clave, idUser, idCliente, Forma_Pago, DATE_FORMAT(FinFecha_Oferta, '%d de %M, %Y')AS FinFecha_Oferta, Dias_Entrega, Comentarios, Sucursal, DATE_FORMAT(Fecha, '%d de %M, %Y')AS Fecha, DATE_FORMAT(Hora, '%h:%i:%s %p')AS Hora, DATE_FORMAT(Entregada, '%d de %M, %Y')AS Entregada FROM Cotizaciones WHERE EStado=7 AND Completada BETWEEN '$Inicio' AND '$Fin' ORDER BY Completada DESC");
                                                } else {
                                                    $consultaCotizacion    =    mysqli_query($MySQLi, "SELECT idCotizacion, Code, Clave, idUser, idCliente, Forma_Pago, DATE_FORMAT(FinFecha_Oferta, '%d de %M, %Y')AS FinFecha_Oferta, Dias_Entrega, Comentarios, Sucursal, DATE_FORMAT(Fecha, '%d de %M, %Y')AS Fecha, DATE_FORMAT(Hora, '%h:%i:%s %p')AS Hora, DATE_FORMAT(Entregada, '%d de %M, %Y')AS Entregada FROM Cotizaciones WHERE idUser='$idUser'AND EStado=7 AND Completada BETWEEN '$Inicio' AND '$Fin' ORDER BY Completada DESC");
                                                }
                                            ...
                                            <tr class="odd gradeX">
                                                        ...
                                                        <tbody><?php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right">$
                                                                    ...
                                                                    $sqlRecibo     =    mysqli_query($MySQLi, "SELECT * FROM Recibos WHERE idCotizacion='$IDCotiza' ") or die(mysqli_error($MySQLi));
																	...
																	<tr>
                                                                        ...
                                                                        if ($dataRecibo['Moneda'] == 'USD') {
                                                                            ...
                                                                            echo '<td class="text-right"><strong>USD $</strong> ' . $Abono . '</td>';
                                                                        } else {
                                                                            $Abono     =    $dataRecibo['Cantidad'];
                                                                            echo '<td class="text-right"><strong>Bs $</strong> ' . $Abono . '</td>';
                                                                        }
                                                                        echo '
																	</tr>';
                                                                    } ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center text-danger"><strong>RESTA</strong></td><?php
                                                                                                                                $ConsultaRecibo_ =    mysqli_query($MySQLi, "SELECT Moneda, SUM(Cantidad)AS porAnticipo, Total FROM Recibos WHERE idCotizacion='$IDCotiza' ");
                                                ...
                                                <td class="text-center"><button class="btn btn-danger btn-xs" onclick="borrarVentaCreditoCancelado(<?php echo $IDCotiza; ?>)" title="Borrar venta por credito(<?php echo $IDCotiza ?>)" id="<?php echo $IDCotiza ?>"><i class="fas fa-trash-alt"></i></button>
                                                </td>
                                                <?php } ?>
                                            </tr><?php $Num++;
                                                } ?>
                ...
                <div class="row tableCotizaciones">
                    <div class="col-md-12">
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                <h4 class="panel-title">COTIZACIONES CANCELADAS AL CRÉDITO
                            ...
                            <div class="panel-body">
                                <form data-parsley-validate="true" class="w-75 m-auto d-none" id="buscar" action="?root=creditosCancelados" method="POST">
                                    <div class="row mb-2">
                                        <div class="col text-center">
                                            <label for="fechaInicio">Fecha de inicio</label>
                                ...
                                <table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle w-100">
                                    ...
                                    <tbody> <?php $Num =    1;
                                                if ($_SESSION['Rango'] == 2) {
                                                    $consultaCotizacion    =    mysqli_query($MySQLi, "SELECT idCotizacion, Code, Clave, idUser, idCliente, Forma_Pago, DATE_FORMAT(FinFecha_Oferta, '%d de %M, %Y')AS FinFecha_Oferta, Dias_Entrega, Comentarios, Sucursal, DATE_FORMAT(Fecha, '%d de %M, %Y')AS Fecha, DATE_FORMAT(Hora, '%h:%i:%s %p')AS Hora, DATE_FORMAT(Entregada, '%d de %M, %Y')AS Entregada FROM Cotizaciones WHERE EStado=7 AND Completada BETWEEN '$startBusqueda' AND '$fecha' ORDER BY Completada DESC");
                                                } else {
                                                    $consultaCotizacion    =    mysqli_query($MySQLi, "SELECT idCotizacion, Code, Clave, idUser, idCliente, Forma_Pago, DATE_FORMAT(FinFecha_Oferta, '%d de %M, %Y')AS FinFecha_Oferta, Dias_Entrega, Comentarios, Sucursal, DATE_FORMAT(Fecha, '%d de %M, %Y')AS Fecha, DATE_FORMAT(Hora, '%h:%i:%s %p')AS Hora, DATE_FORMAT(Entregada, '%d de %M, %Y')AS Entregada FROM Cotizaciones WHERE idUser='$idUser'AND EStado=7 AND Completada BETWEEN '$startBusqueda' AND '$fecha' ORDER BY Completada DESC");
                                                }
                                                while ($dataCotizacion = mysqli_fetch_assoc($consultaCotizacion)) {
                                                    $IDCotiza     =    $dataCotizacion['idCotizacion']; ?>
                                            <tr class="odd gradeX">
