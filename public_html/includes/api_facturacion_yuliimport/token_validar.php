...
{
    if (token_vigente()) {
        echo json_encode('Token Vigente 01Yuliimport');
    } else {
        echo  token_regenerar() ? json_encode('Token regenerado en api y actualizado en BD 01Yuliimport') : json_encode('Token vencido y error al actualizar 01Yuliimport');
    }
}
