                ...
                <div class="col-md-8">
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h1 class="panel-title">LA PAZ</h1>
            ...
            <div class="row tableUsers">
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4 class="panel-title">Lista De Facturas LA PAZ
                                &nbsp;&nbsp;&nbsp;
                            ...
                            <div class="panel-heading-btn">
                                <div class="input-group input-daterange">
                                    <form action="?root=facturacionReportesLaPaz" method="post">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    ...
                                    FROM
                                        factura
                                    WHERE
                                        branchId = 2 AND siatCodeState = 908 AND ( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' )") or die(mysqli_error($MySQLi));
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="widget widget-stats bg-success">
                                        ...
                                        factura
                                    WHERE
                                        branchId = 2 AND siatCodeState = 908 AND ( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' )");
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="widget widget-stats bg-gray">
                                        ...
                                        factura
                                    WHERE
                                        branchId = 2 AND siatCodeState = 905 AND ( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' )");
                                    ...
                                    <div class="widget widget-stats bg-info">
                                        ...
                                        <div class="stats-info">
                                            ...
                                            <p><?php
                                                ...
                                                $totalfacturado = 0;
                                                $QueryFactura = mysqli_query($MySQLi, "SELECT* FROM detailInvoice WHERE branchId=2  AND( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' ) ORDER BY invoiceNumber DESC");

                                                while ($data = mysqli_fetch_assoc($QueryFactura)) {

                                                    $nroFactura = $data['invoiceNumber'];
                                                    $qtyFactura = $data['qty'];
                                                    $QueryFacturaCabezera = mysqli_query($MySQLi, "SELECT* FROM factura WHERE branchId=2 AND invoiceNumber='$nroFactura'  ");
                            ...
                            <table id="data-table-buttons" width="100%" class="table table-striped table-bordered table-td-valign-middle w-100">
                                ...
                                <tbody>
                                    ...
                                    // $QueryFactura = mysqli_query($MySQLi, "SELECT* FROM detailInvoice WHERE branchId=2 ORDER BY invoiceNumber DESC");
                                    ...
                                    //                             DESC
                                    //                                 ");
                                    //$QueryFactura = mysqli_query($MySQLi, "SELECT* FROM factura WHERE branchId=2 ORDER BY invoiceNumber DESC");
                                    $QueryFactura = mysqli_query($MySQLi, "SELECT* FROM detailInvoice WHERE branchId=2 AND(DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' )  ORDER BY invoiceNumber DESC");
