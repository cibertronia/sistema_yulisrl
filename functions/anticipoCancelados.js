...
function borrarVentaAnticipoCancelado(id) {
	...
	.then((result) => {
		if (result.value) {
			$.ajax({
				...
				type: 'POST',
				dataType: 'html',
				data: "action=BorrarVentaporAnticipoCancelado&idCotizacion=" + id,
			})
			.done(function (data) {
				$(".respuesta").html(data);
			})
...
function borrarVentaCreditoCancelado(id) {
	const swalWithBootstrapButtons = Swal.mixin({
		customClass: {
			confirmButton: 'btn btn-success',
			cancelButton: 'btn btn-danger',
	...
	.then((result) => {
		if (result.value) {
			$.ajax({
				...
				type: 'POST',
				dataType: 'html',
				data: "action=eliminarCreditoCancelado&idCotizacion=" + id,
			})
			.done(function (data) {
				$(".respuesta").html(data);
			})
